...
/** WP_Network class */
require_once dirname( __FILE__ ) . '/class-wp-network.php';

/** WP_Site class */
require_once dirname( __FILE__ ) . '/class-wp-site.php';

/** Multisite loader */
require_once dirname( __FILE__ ) . '/ms-load.php';

/** Default Multisite constants */
require_once dirname( __FILE__ ) . '/ms-default-constants.php';
